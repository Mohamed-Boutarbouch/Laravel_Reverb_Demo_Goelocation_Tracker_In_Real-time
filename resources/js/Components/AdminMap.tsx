...
type PayloadCoords = { lat: number; lng: number };

export function AdminMap() {
  const mapRef = useRef(null);
  const CENTER: LatLngExpression = [34.00501829905671, -4.957129955291749];
  const [courierCoords, setCourierCoords] = useState<PayloadCoords | null>({
  ...
  useEffect(() => {
    echo
      .private("geolocation")
      .listen("CoordinateSent", (payload: PayloadCoords) => {
